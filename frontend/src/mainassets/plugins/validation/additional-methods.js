...
jQuery.validator.addMethod("pwcheckM", function(value) {
...
}, jQuery.format("Password must be 8 characters with a combination of alpha, numeric, special character, and 1 upper case."));